...
AS $$
BEGIN
    -- Valores fijos de volumen (ajustalos acá una sola vez)
    -- campos=3, lotes_por_campo=3, sectores_por_lote=2, pivotes_por_campo=2
    -- dispositivos_por_tipo=3, gateways=2, mediciones=800, eventos_por_regla=3, usuarios=6
    ...
    -- ... acá va el mismo cuerpo de inserts que te pasé antes,
    -- reemplazando parámetros por constantes:
    -- p_campos -> 3
    -- p_lotes_por_campo -> 3
    -- p_sectores_por_lote -> 2
    -- p_pivotes_por_campo -> 2
    -- p_dispositivos_por_tipo -> 3
    -- p_gateways -> 2
    -- p_mediciones -> 800
    -- p_eventos_por_regla -> 3
    -- p_usuarios -> 6
END;
$$;